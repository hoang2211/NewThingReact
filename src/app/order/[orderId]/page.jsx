...
const products = [
  ...
  },
  {
    ...
    phone: '1•••••••••40',
    imageSrc:
      'https://tailwindui.com/plus-assets/img/ecommerce-images/confirmation-page-03-product-02.jpg',
    imageAlt:
    ...
    <div className="bg-gray-50">
      ...
      <main className="mx-auto max-w-2xl pt-8 pb-24 sm:px-6 sm:pt-16 lg:max-w-7xl lg:px-8">
        <div className="space-y-2 px-4 sm:flex sm:items-baseline sm:justify-between sm:space-y-0 sm:px-0">
          ...
          <a
            href="#"
            className="text-sm font-medium text-cyan-600 hover:text-cyan-500 sm:hidden"
          >
            View invoice
            <span aria-hidden="true"> &rarr;</span>
          </a>
                ...
                <div className="border-t border-gray-200 px-4 py-6 sm:px-6 lg:p-8">
                  ...
                  <div aria-hidden="true" className="mt-6">
                    ...
                    <div className="mt-6 hidden grid-cols-4 text-sm font-medium text-gray-600 sm:grid">
                      <div className="text-cyan-600">Order placed</div>
                      <div
                        className={classNames(
                          product.step > 0 ? 'text-cyan-600' : '',
                          'text-center',
                        )}
                      >
                        Processing
          ...
          <div className="bg-gray-100 px-4 py-6 sm:rounded-lg sm:px-6 lg:grid lg:grid-cols-12 lg:gap-x-8 lg:px-8 lg:py-8">
            ...
            <dl className="mt-8 divide-y divide-gray-200 text-sm lg:col-span-5 lg:mt-0">
              ...
              <div className="flex items-center justify-between pt-4">
                ...
                <dd className="font-medium text-cyan-600">$83.16</dd>
              </div>
            </dl>
          </div>
        </section>
